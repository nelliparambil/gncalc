...
class Calculator(Frame):
    ...
    def init_calculator_gui(self):    
        ...
        btn_clear = Button(self.keypad_container, text="C", height=2,
                padx=1, pady=1,
                width=5, command=lambda: self.update_display_text('C'))        
        btn_clear.grid(row=0, column=4)
        btn_seven = Button(self.keypad_container, text="7",
                command=lambda: self.update_display_text('7'))
        btn_seven.grid(row=1, column=0)
        btn_eight = Button(self.keypad_container, text="8",
                command=lambda: self.update_display_text('8'))        
        btn_eight.grid(row=1, column=1)
        btn_nine = Button(self.keypad_container, text="9",
                command=lambda: self.update_display_text('9'))        
        btn_nine.grid(row=1, column=2)
        btn_add = Button(self.keypad_container, text="+",
                command=lambda: self.update_display_text('+'))        
        btn_add.grid(row=1, column=3)
        btn_ac = Button(self.keypad_container, text="AC",
                command=lambda: self.update_display_text('AC'))        
        btn_ac.grid(row=1, column=4)
        btn_four = Button(self.keypad_container, text="4",
                command=lambda: self.update_display_text('4'))        
        btn_four.grid(row=2, column=0)
        btn_five = Button(self.keypad_container, text="5",
                command=lambda: self.update_display_text('5'))
        btn_five.grid(row=2, column=1)
        btn_six = Button(self.keypad_container, text="6",
                command=lambda: self.update_display_text('6'))        
        btn_six.grid(row=2, column=2)
        btn_openbrace = Button(self.keypad_container, text="(",
                command=lambda: self.update_display_text('('))        
        btn_openbrace.grid(row=2, column=3)
        btn_one = Button(self.keypad_container, text="1",
                command=lambda: self.update_display_text('1'))        
        btn_one.grid(row=3, column=0)
        btn_two = Button(self.keypad_container, text="2",
                command=lambda: self.update_display_text('2'))        
        btn_two.grid(row=3, column=1)
        btn_three = Button(self.keypad_container, text="3",
                command=lambda: self.update_display_text('3'))        
        btn_three.grid(row=3, column=2)
        btn_equals = Button(self.keypad_container, text="=",
                command=lambda: self.update_display_text('='))        
        btn_equals.grid(row=3, column=3)
        btn_closebrace = Button(self.keypad_container, text=")",
                command=lambda: self.update_display_text(')'))        
        btn_closebrace.grid(row=3, column=4)
        btn_zero = Button(self.keypad_container, text="0",
                command=lambda: self.update_display_text('0'))        
        btn_zero.grid(row=4, column=0)
        btn_comma = Button(self.keypad_container, text=",",
                command=lambda: self.update_display_text(','))        
        btn_comma.grid(row=4, column=1)
        btn_plusorminus = Button(self.keypad_container, text="+/-",
                command=lambda: self.update_display_text('+/-'))        
